...
const foo = async () => {
  const fetchFormItems = () =>
    axios.get(
      `https://sheets.googleapis.com/v4/spreadsheets/1tfg7yW8GKWSHRVGey-o3AQ-fqcKR3aZUqyY2_lE1AB0/values:batchGet?ranges=carousel&majorDimension=ROWS&key=AIzaSyAvHGj2tlVVdPnqq3stJdYB3sJuT-2h9aQ`
    )
  ...
  console.log("data from page3", rows)
}
foo()
const BlogPage = () => {
